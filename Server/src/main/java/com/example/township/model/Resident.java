...
public String toString() {
	return "Resident [ResidentID=" + ResidentID + ", FirstName=" + FirstName + ", LastName=" + LastName
			+ ", ResidentLoginID=" + ResidentLoginID + ", Password=" + Password + ", ContactNo=" + ContactNo
			+ ", EmailID=" + EmailID + ", WingNO=" + WingNO + ", Floor=" + Floor + ", FlatNo=" + FlatNo + "]";
}
}
